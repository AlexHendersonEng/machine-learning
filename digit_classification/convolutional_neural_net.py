...
class DigitClassifier(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 3, (3, 3), 1, 0)  # 1x26x26
        self.conv2 = nn.Conv2d(3, 3, (3, 3), 1, 0)  # 3x24x24
...
if train:
    ...
    # Save model weights
    torch.save(model.state_dict(), 'models/convolutional_neural_net.pth')

else:
    model.load_state_dict(torch.load('models/convolutional_neural_net.pth'))
